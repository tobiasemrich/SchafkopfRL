...
class Game_State():
  ...
  def get_rewards(self):
    ...
    if player_team_points > self.rules.winning_thresholds[4] or player_team_points <= self.rules.winning_thresholds[0]: # schwarz
      reward += self.rules.reward_schneider[2]
    elif player_team_points > self.rules.winning_thresholds[3] or player_team_points <= self.rules.winning_thresholds[1]: # schneider
